...
int click_pencilbutton(buttonmenu_t *button)
{
...
int hover_pencilbutton(buttonmenu_t *button)
{
    ...
    mouse_pos.y <= button_pos.y + button_size.y) {
        ...
        return (click_pencilbutton(button));
    } else {
...
buttonmenu_t *set_pencilbutton(buttonmenu_t *button)
{
    ...
    sfText_setString(button->text, "Pencil");
...
buttonmenu_t *init_pencilbutton(void)
{
    ...
    button->position = (sfVector2f){200, 100};
    ...
    button = set_pencilbutton(button);
