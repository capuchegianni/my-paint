...
buttonmenu_t *set_openfilebutton(buttonmenu_t *button)
{
    ...
    sfText_setString(button->text, "Openfile");
...
buttonmenu_t *init_openfilebutton(void)
{
    ...
    button->position = (sfVector2f){0, 100};
    ...
    button = set_openfilebutton(button);
