...
void eraser_text(tool_bar_t *bar)
{
    ...
    sfText_setPosition(bar->eraser_size->text, (sfVector2f){55, 335});
...
void eraser_nbr(tool_bar_t *bar)
{
    ...
    if (bar->eraser_size->nbr > 99)
        sfText_setPosition(bar->eraser_size->tnbr, (sfVector2f){110, 380});
...
void eraser_less(tool_bar_t *bar)
{
    ...
    bar->eraser_size->less->pos = (sfVector2f){62, 390};
    ...
    sfText_setPosition(bar->eraser_size->less->text, (sfVector2f){65, 382});
...
void eraser_more(tool_bar_t *bar)
{
    ...
    bar->eraser_size->more->pos = (sfVector2f){170, 390};
    ...
    sfText_setPosition(bar->eraser_size->more->text, (sfVector2f){173, 382});
